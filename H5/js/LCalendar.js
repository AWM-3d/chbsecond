    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function (type) {
            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    if (!isNaN(top)) {
                        ...
                        date_yy.style["-webkit-transform"] = 'translate3d(0,' + (8 - yyVal * 2) +
                            'em,0)';
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    date_mm.style["-webkit-transform"] = 'translate3d(0,' + (8 - (mmVal - minM) * 2) +
                        'em,0)';
                ...
                if (date_dd && date_dd.getAttribute("val")) {
                    ...
                    date_dd.style["-webkit-transform"] = 'translate3d(0,' + (8 - (ddVal - minD) * 2) +
                        'em,0)';
            ...
            function gearTouchMove(e) {
                ...
                target.style["-webkit-transform"] = 'translate3d(0,' + target["pos_" + target.id] +
                    'em,0)';
            ...
            function gearTouchEnd(e) {
                ...
                var flag = (target["new_" + target.id] - target["old_" + target.id]) / (target["n_t_" +
                    target.id] - target["o_t_" + target.id]);
            ...
            function finishMobileDate(e) {
                var passY = _self.maxY - _self.minY + 1;
                var date_yy = parseInt(Math.round(_self.gearDate.querySelector(".date_yy").getAttribute(
                    "val")));
                var date_mm = parseInt(Math.round(_self.gearDate.querySelector(".date_mm").getAttribute(
                    "val"))) + 1;
                date_mm = date_mm > 9 ? date_mm : '0' + date_mm;
                var date_dd = parseInt(Math.round(_self.gearDate.querySelector(".date_dd").getAttribute(
                    "val"))) + 1;
            ...
            function finishMobileDateTime(e) {
                ...
                var date_dd = parseInt(Math.round(_self.gearDate.querySelector(".date_dd").getAttribute(
                    "val"))) + 1;
                date_dd = date_dd > 9 ? date_dd : '0' + date_dd;
                var time_hh = parseInt(Math.round(_self.gearDate.querySelector(".time_hh").getAttribute(
                    "val")));
                time_hh = time_hh > 9 ? time_hh : '0' + time_hh;
                var time_mm = parseInt(Math.round(_self.gearDate.querySelector(".time_mm").getAttribute(
                    "val")));
                time_mm = time_mm > 9 ? time_mm : '0' + time_mm;
                _self.trigger.value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd +
                    " " + (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") +
                    time_mm;
                closeMobileCalendar(e);
            }
            ...
            function finishMobileTime(e) {
                ...
                var time_mm = parseInt(Math.round(_self.gearDate.querySelector(".time_mm").getAttribute(
                    "val")));
                time_mm = time_mm > 9 ? time_mm : '0' + time_mm;
                _self.trigger.value = (time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ?
                    ":0" : ":") + time_mm;
                closeMobileCalendar(e);
            }
